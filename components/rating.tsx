...
const Rating = () => {
  ...
  const handleSubmit = () => {
    if (selectedRating) {
      setSubmitted(true); // Show the confirmation screen after submitting
    }
  };
    ...
    <div className="container bg-gray-900 rounded-3xl w-96 h-96">
      {!submitted ? (
        <>
          ...
          <div className="ml-8 mt-8 flex flex-col justify-center">
            ...
            <div className="flex justify-center w-[80%] mt-4 items-center text-white">
              {[1, 2, 3, 4, 5].map((rating) => (
                <div
                  ...
                  className={`flex justify-center items-center bg-gray-700 rounded-full w-10 h-10 hover:bg-orange-400 hover:text-black ml-4 cursor-pointer ${
                    selectedRating === rating ? "bg-orange-400 text-black" : ""
                  }`}
                >
                  {rating}
                </div>
            ...
            <button
              ...
              className="bg-orange-400 flex justify-center items-center w-[80%] mt-4 rounded-2xl py-1 hover:bg-white ml-4 mb-4"
            >
              SUBMIT
            </button>
          </div>
        ...
        <div className="flex flex-col justify-center items-center h-full">
          ...
          <p className=" mt-4 w-[60%] text-center bg-zinc-700 rounded-2xl py-1 text-orange-600">
            You selected {selectedRating} out of 5
          </p>
          <h1 className="text-white text-3xl mt-6">Thank you!</h1>
          <p className="text-zinc-600 mt-4 w-[70%] text-center">
